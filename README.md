...
The JSON modules proposal builds on the [import assertions proposal](https://github.com/tc39/proposal-import-assertions/) to add the ability to import a JSON module in a common way across JavaScript environments.
